          ...
          <v-card-text>
            <v-container>
              <form @submit.prevent="onSignup">
                ...
                <v-layout row>
                  <v-flex xs12>
                    <v-text-field name="confirmePassword" label="Confirm Password" id="confirmPassword" v-model="confirmPassword" type="password" :rules="[comparePasswords]"></v-text-field>
                  </v-flex>
                </v-layout>
